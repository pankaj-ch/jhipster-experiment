...
import com.hachi.app.config.EmbeddedKafka;
import com.hachi.app.config.KafkaSseConsumer;
import com.hachi.app.config.KafkaSseProducer;
...
class HachiKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/hachi-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
